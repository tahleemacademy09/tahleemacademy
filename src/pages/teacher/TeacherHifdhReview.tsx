                              ...
                              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8}}>
                                ...
                                {pr.ayahCorrectness&&(
                                  <span style={{fontSize:10,fontWeight:700}}>
                                    <span style={{color:PASS}}>✓{pr.ayahCorrectness.filter(Boolean).length} correct</span>
                                    {" · "}
                                    <span style={{color:FAIL}}>✗{pr.ayahCorrectness.filter(v=>!v).length} missed</span>
                                  </span>
                                )}
                              </div>
                                ...
                                {pr.ayahs.map((a,i)=>{
                                  ...
                                  return (
                                    <span key={i} style={{
                                      ...
                                      borderRadius:4,
                                      outline:`1px solid ${correct?PASS+"33":FAIL+"22"}`,
                          ...
                          {pr.errorWords&&pr.errorWords.length>0&&(
                            <div style={{padding:"0 14px 12px"}}>
                              <p style={{fontSize:10,fontWeight:800,color:FAIL,
                                ...
                                ⚠️ Missed words ({Math.min(pr.errorWords.length,12)})
                              </p>
                              <div style={{display:"flex",flexWrap:"wrap",gap:4,direction:"rtl"}}>
                                {pr.errorWords.slice(0,12).map((w,i)=>(
