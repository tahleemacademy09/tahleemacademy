...
import ProctoringOverlay, { attachDisplayVideo } from "@/components/exam/ProctoringOverlay";
...
const ExamTaking = () => {
  ...
  useEffect(()=>{
    if(proc.cameraReady&&proc.getStream){
      setTimeout(()=>attachDisplayVideo(proc.getStream()),500);
    }
  },[proc.cameraReady]);
    ...
    <div style={{height:"100vh",display:"flex",flexDirection:"column",background:"#f0f2f5",fontFamily:"'Cairo',sans-serif",userSelect:"none",WebkitUserSelect:"none",overflow:"hidden"}} onContextMenu={e=>e.preventDefault()}>
      <style>{`
        ...
        *{box-sizing:border-box}
        .lg\\:flex{display:flex}@media(max-width:1024px){.lg\\:flex{display:none!important}}
        .lg\\:hidden{display:none}@media(max-width:1024px){.lg\\:hidden{display:flex!important}}
      `}</style>
      ...
      <div style={{height:56,background:G,display:"flex",alignItems:"center",padding:"0 14px",gap:10,flexShrink:0,zIndex:40,boxShadow:"0 2px 8px rgba(0,0,0,.3)"}}>
        ...
        {/* Mobile nav toggle */}
        <button onClick={()=>setShowNav(v=>!v)} style={{background:"rgba(255,255,255,.12)",border:"none",color:"rgba(255,255,255,.8)",borderRadius:8,padding:"6px 8px",cursor:"pointer",flexShrink:0}} className="lg:hidden">
      ...
      <div style={{flex:1,display:"flex",overflow:"hidden",minHeight:0}}>
        ...
        <div style={{width:170,background:"#fff",borderRight:`1px solid ${BORDER}`,display:"flex",flexDirection:"column",overflow:"hidden",flexShrink:0}} className="lg:flex">
        ...
        <div style={{width:170,background:"#fff",borderLeft:`1px solid ${BORDER}`,display:"flex",flexDirection:"column",flexShrink:0,padding:12,gap:10,overflow:"hidden"}} className="lg:flex">
      ...
      {/* ── MOBILE BOTTOM NAV ── */}
      <div style={{background:"#fff",borderTop:`1px solid ${BORDER}`,padding:"8px 10px",flexShrink:0,display:"flex"}} className="lg:hidden">
        {showNav?(
          <div style={{width:"100%"}}>
