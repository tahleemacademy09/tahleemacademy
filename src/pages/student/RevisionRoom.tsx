/*
  RevisionRoom.tsx — Complete Revision & Practice System
  
  Features:
  1. Flashcards — manual + AI-generated from topic/exam
  2. Quiz — from flashcards, from real exam questions, AI-generated by topic
  3. Summaries — teacher-uploaded or AI-generated
  4. My Notes — personal notes
  5. Progress — stats and history
*/
...
import {
  ...
  Star, Eye, EyeOff, Trash2, Edit, X, Check,
} from "lucide-react";
...
const RevisionRoom = () => {
  ...
  const { data: materials = [] } = useQuery({
    ...
    enabled: !!subjectId,
    queryFn: async () => {
      const { data } = await supabase.from("subject_materials").select("*")
  ...
  // Exams for this subject's courses
  ...
  /* Extract text from specific pages of a PDF given a signed URL */
  ...
  /* Resolve a Supabase storage path to a signed URL */
  ...
  /* Generate flashcards FROM material pages */
...
Make questions educational and progressively challenging.`
      ...
      <div style={{ minHeight:"100svh", background:"#F8F9FA", display:"flex", flexDirection:"column", alignItems:"center", padding:"20px 16px" }}>
        <div style={{ width:"100%", maxWidth:500 }}>
          ...
          <div onClick={()=>setFlipped(f=>!f)}
            style={{ background:"#fff", borderRadius:20, border:`2px solid ${flipped?"#D97706":G}`, padding:"40px 24px", minHeight:220, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", cursor:"pointer", textAlign:"center", boxShadow:"0 4px 20px rgba(0,0,0,.08)", transition:"border-color .2s", marginBottom:20 }}>
            <div style={{ fontSize:11, fontWeight:700, textTransform:"uppercase", letterSpacing:1, color:flipped?"#D97706":G, marginBottom:12 }}>
  ...
  return (
    <div style={{ minHeight:"100svh", background:"#F8F9FA" }}>
      ...
      <div style={{ padding:"20px 16px", maxWidth:720, margin:"0 auto" }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
            ...
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:10 }}>
              ...
              <div style={{ display:"flex", gap:8, flexWrap:"wrap" }}>
                ...
                <button onClick={()=>setShowAiCard(true)}
                  style={{ display:"flex", alignItems:"center", gap:6, padding:"9px 16px", borderRadius:10, border:"none", background:"#7C3AED", color:"#fff", cursor:"pointer", fontSize:13, fontWeight:700 }}>
            ...
            {flashcards.length===0 ? (
              <div style={{ textAlign:"center", padding:"56px 24px", background:"#fff", borderRadius:20, border:"2px dashed #E5E7EB" }}>
                ...
                <div style={{ display:"flex", gap:10, justifyContent:"center" }}>
                  <button onClick={()=>setShowAiCard(true)} style={{ display:"flex", alignItems:"center", gap:6, padding:"10px 18px", borderRadius:11, border:"none", background:"#7C3AED", color:"#fff", cursor:"pointer", fontWeight:700, fontSize:13 }}>
        ...
        {tab==="quiz" && (
          <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
            ...
            {/* AI Topic Quiz */}
              <div style={{ background:"linear-gradient(135deg,#7C3AED,#6D28D9)", borderRadius:16, padding:"18px 20px" }}>
                <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:10 }}>
                  <div style={{ display:"flex", alignItems:"center", gap:10 }}>
                    <span style={{ fontSize:28 }}>🤖</span>
                    <div>
                ...
                <div key={s.id} style={{ background:"#fff", borderRadius:14, border:"1px solid #E5E7EB", padding:"16px" }}>
                  <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:8 }}>
                    ...
                    <div style={{ display:"flex", gap:6 }}>
                      ...
                      {s.is_ai_generated && <span style={{ fontSize:10, padding:"2px 8px", borderRadius:20, background:"#F3E8FF", color:"#7C3AED" }}>AI</span>}
                    </div>
                  </div>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"repeat(2,1fr)", gap:10 }}>
              {[
                ...
                {label:"Quizzes Taken", value:quizHistory.length,                  icon:"🏆",color:"#FDF4FF",text:"#7C3AED"},
      ...
      <Dialog open={showMatGen} onOpenChange={v=>{ if(!v){setShowMatGen(false);setSelMaterial(null);setMatGenStep("pick");} }}>
            ...
            <div style={{ padding:20, display:"flex", flexDirection:"column", gap:16 }}>
              ...
              {(selMaterial.material_type==="PDF"||selMaterial.file_type?.includes("pdf")||(selMaterial.file_url||"").split(".").pop()?.toLowerCase()==="pdf") && (
                <div>
                  <p style={{ fontSize:12, fontWeight:700, color:"#374151", marginBottom:10 }}>
                    📖 Page Range <span style={{ color:"#9CA3AF", fontWeight:400 }}>(AI will only read these pages)</span>
                  </p>
                  <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                    <div style={{ flex:1 }}>
                      <label style={{ fontSize:11, fontWeight:600, color:"#6B7280", display:"block", marginBottom:4 }}>From page</label>
                      <input type="number" min={1} value={pageFrom}
                    ...
                    <div style={{ flex:1 }}>
                      ...
                      <input type="number" min={pageFrom} value={pageTo}
              ...
              <div>
                <p style={{ fontSize:12, fontWeight:700, color:"#374151", marginBottom:8 }}>
                  Number of {matGenMode==="flashcard"?"flashcards":"questions"}
                </p>
              ...
              <button onClick={generateFromMaterial}
                style={{ padding:"14px", borderRadius:12, border:"none", background:"#0F766E", color:"#fff", cursor:"pointer", fontWeight:700, fontSize:14, display:"flex", alignItems:"center", justifyContent:"center", gap:8 }}>
                <span style={{ fontSize:18 }}>🤖</span> Generate {numQuestions} {matGenMode==="flashcard"?"Flashcards":"Questions"} from Pages {pageFrom}–{pageTo}
              </button>
            </div>
          )}
      ...
      <Dialog open={showAiCard} onOpenChange={setShowAiCard}>
        <DialogContent style={{ maxWidth:440, borderRadius:20, padding:0 }}>
          <div style={{ background:"linear-gradient(135deg,#7C3AED,#6D28D9)", padding:"18px 20px", borderRadius:"20px 20px 0 0", display:"flex", alignItems:"center", gap:10 }}>
          ...
          <div style={{ padding:20, display:"flex", flexDirection:"column", gap:14 }}>
              ...
              <div style={{ display:"flex", gap:8 }}>
                {[5,10,15,20].map(n=>(
                  <button key={n} onClick={()=>setAiCardCount(n)}
                    style={{ flex:1, padding:"9px", borderRadius:9, border:`2px solid ${aiCardCount===n?"#7C3AED":"#E5E7EB"}`, background:aiCardCount===n?"#F3E8FF":"#fff", color:aiCardCount===n?"#7C3AED":"#374151", cursor:"pointer", fontWeight:700, fontSize:13 }}>
                    {n}
                  </button>
                ))}
              </div>
            ...
            <button onClick={generateAiFlashcards} disabled={!aiCardTopic.trim()||aiCardLoading}
              style={{ padding:"13px", borderRadius:12, border:"none", background:aiCardTopic.trim()?"#7C3AED":"#E5E7EB", color:aiCardTopic.trim()?"#fff":"#9CA3AF", cursor:aiCardTopic.trim()?"pointer":"not-allowed", fontWeight:700, fontSize:14, display:"flex", alignItems:"center", justifyContent:"center", gap:8 }}>
      ...
      <Dialog open={showAiQuiz} onOpenChange={setShowAiQuiz}>
        <DialogContent style={{ maxWidth:440, borderRadius:20, padding:0 }}>
          ...
          <div style={{ padding:20, display:"flex", flexDirection:"column", gap:14 }}>
            ...
            <div style={{ background:"#F3E8FF", borderRadius:12, padding:"12px 14px", border:"1px solid #DDD6FE" }}>
              <p style={{ fontSize:12, fontWeight:600, color:"#6D28D9", margin:0 }}>💡 Tips for better questions:</p>
              <ul style={{ fontSize:11, color:"#7C3AED", margin:"6px 0 0 0", paddingLeft:16, lineHeight:1.8 }}>
            ...
            <button onClick={generateAiQuiz} disabled={!aiQuizTopic.trim()||quizLoading}
              style={{ padding:"13px", borderRadius:12, border:"none", background:aiQuizTopic.trim()?"#7C3AED":"#E5E7EB", color:aiQuizTopic.trim()?"#fff":"#9CA3AF", cursor:aiQuizTopic.trim()?"pointer":"not-allowed", fontWeight:700, fontSize:14, display:"flex", alignItems:"center", justifyContent:"center", gap:8 }}>
