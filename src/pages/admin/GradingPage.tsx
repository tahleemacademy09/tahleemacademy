...
import {
  ...
  Send, Users, Lock, Unlock, Loader2, Eye, ChevronRight, BarChart2, Play
} from "lucide-react";
                  ...
                  {(() => {
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                      ...
                      <div style={{ background: "linear-gradient(135deg,#064E3B,#065F46)", borderRadius: 12, padding: "14px 16px", display: "flex", alignItems: "center", gap: 14 }}>
                        ...
                        <div style={{ flex: 1 }}>
                          <p style={{ fontSize: 13, fontWeight: 800, color: "#fff", margin: "0 0 2px" }}>Student Voice Recording</p>
                          <p style={{ fontSize: 11, color: "rgba(255,255,255,.65)", margin: 0 }}>Listen before grading — use controls below</p>
                        </div>
                      </div>
                  ...
                  <div style={{ marginTop: 12, background: "#F0FDF4", borderRadius: 12, padding: "14px 16px", border: "1.5px solid #BBDDC8" }}>
                    ...
                    {(scoreRefs.current[selectedAttempt.id]||{})[i] !== undefined && (
                      <p style={{ fontSize: 11, color: G, fontWeight: 700, margin: "8px 0 0" }}>
                        ✓ Scored {(scoreRefs.current[selectedAttempt.id]||{})[i]} / {q.points||1} points
                      </p>
                    )}
                  </div>
                )}
