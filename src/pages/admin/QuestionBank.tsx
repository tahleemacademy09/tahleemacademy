        ...
        <DialogContent style={{ maxWidth: 520, borderRadius: 20, padding: 0 }}>
          ...
          {previewQ && (
            <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              {(previewQ.reading_passage || previewQ.reading_passage_ar) && (
                <div style={{ padding: "12px 14px", borderRadius: 10, background: "#FFFBEB", border: "1px solid #FDE68A", borderLeft: "4px solid #C9A84C" }}>
                  ...
                  {previewQ.reading_passage_ar && (
                    <div dir="rtl" style={{ fontSize: 13, lineHeight: 1.8, fontFamily: "'Amiri',serif", marginTop: previewQ.reading_passage ? 6 : 0 }} dangerouslySetInnerHTML={{ __html: sanitizeHtml(previewQ.reading_passage_ar) }} />
                  )}
                </div>
              )}
